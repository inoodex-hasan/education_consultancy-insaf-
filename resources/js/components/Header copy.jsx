        ...
        <header className="overflow-x-hidden">
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow">
                <div className="container mx-auto flex justify-between items-center p-4">
                                ...
                                {navItem.child && (
                                    <ul className="absolute w-[250px] left-0 bg-blue py-1 shadow-lg hidden group-hover:block transition-all duration-300">
                                        {navItem.child.map((child) => (
                                            <li
                                                key={child.id}
                                                className="py-2 px-2 hover:bg-blue/60 transition-all"
                                            >
                                                <Link
                                                    href={child.url}
                                                    className="block font-normal hover:font-medium"
                                                >
                                                    {child.title}
                                                </Link>
                                            </li>
                    ...
                    {/* Mobile Toggle */}
                    <button
                        onClick={() => setShowOffMenu(!showOffMenu)}
                        className="lg:hidden"
                    >
                        {showOffMenu ? (
                            <IoMdClose size={35} />
                    ...
                    <div className="flex flex-col gap-4">
                        {navItems.map((navItem) => (
                            <div key={navItem.id}>
                                <div
                                    onClick={() =>
                                        toggleMobileSubMenu(navItem.id)
                                    }

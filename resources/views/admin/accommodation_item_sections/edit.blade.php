...
@section('title', 'Edit Accommodation Item Section')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="edit-form"
                                action="{{ route('admin.accommodation_item_sections.update', $accommodation_item_section) }}"
                                ...
                                <div class="row">
                                        ...
                                        <select name="accommodation_item_id"
                                            ...
                                            @foreach ($accommodationItems as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('accommodation_item_id', $accommodation_item_section->accommodation_item_id) == $item->id ? 'selected' : '' }}>
                                                    {{ $item->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="description" class="summernote @error('description') is-invalid @enderror" rows="6">{{ old('description', $accommodation_item_section->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="row" id="existing-images-container">
                                            @forelse ($accommodation_item_section->images ?? [] as $path)
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="{{ route('admin.accommodation_item_sections.index') }}"

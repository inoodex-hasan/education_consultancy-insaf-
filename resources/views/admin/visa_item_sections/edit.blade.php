...
@section('title', 'Edit Visa Item Section')

@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Visa Item Sections</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ route('admin.visa_item_sections.index') }}">All Sections</a></div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('admin.visa_item_sections.index') }}" class="btn btn-primary">
                                    Back to List
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <form id="edit-form" action="{{ route('admin.visa_item_sections.update', $visa_item_section) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label> Visa Item <span class="text-danger">*</span></label>
                                        <select name="visa_item_id"
                                            class="form-control @error('visa_item_id') is-invalid @enderror" required>
                                            <option value="">-- Select Item --</option>
                                            @foreach ($visaItems as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('visa_item_id', $visa_item_section->visa_item_id) == $item->id ? 'selected' : '' }}>
                                                    {{ $item->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="description" class="summernote @error('description') is-invalid @enderror" rows="6">{{ old('description', $visa_item_section->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="row" id="existing-images-container">
                                            @forelse ($visa_item_section->images ?? [] as $path)
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="{{ route('admin.visa_item_sections.index') }}"

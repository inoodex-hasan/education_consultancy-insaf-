                            ...
                            <form action="{{ route('admin.events.update', $event->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="description" rows="4" class="summernote @error('description') is-invalid @enderror">{{ old('description', $event->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-9">
                                        ...
                                        <div class="mt-2">
                                            @if ($event->photo_path)
                                                <img src="{{ asset($event->photo_path) }}" class="img-fluid rounded"

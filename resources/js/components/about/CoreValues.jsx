            ...
            ${
                isGold
                    ...
                    : "bg-gradient-to-br from-[#283e77] to-blue-900"
                                ...
                                ></div>
                                {/* Card – make it grow to fill the space */}
                                <div className="relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-gray-100 flex-1 flex flex-col">
                                    {" "}
              ...
              ${isGold ? "text-[#c3a25d]" : "text-[#283e77]"}`}
                                    ...
                                    {/* Description – push to bottom if you want, or just let it grow naturally */}

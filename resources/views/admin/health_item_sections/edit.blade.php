...
@section('title', 'Edit Health Item Section')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="edit-form"
                                action="{{ route('admin.health_item_sections.update', $health_item_section) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Parent Health Item <span class="text-danger">*</span></label>
                                        <select name="health_item_id"
                                            ...
                                            @foreach ($healthItems as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('health_item_id', $health_item_section->health_item_id) == $item->id ? 'selected' : '' }}>
                                                    {{ $item->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="description" class="summernote @error('description') is-invalid @enderror" rows="6">{{ old('description', $health_item_section->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="row" id="existing-images-container">
                                            @forelse ($health_item_section->images ?? [] as $path)
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="{{ route('admin.health_item_sections.index') }}"

    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link" href="{{ route('admin.destination_item_sections.index') }}">Manage
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="has-dropdown">Item Sections</a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="{{ route('admin.scholarship_item_sections.create') }}">Add
                                </a></li>
                            <li><a class="nav-link" href="{{ route('admin.scholarship_item_sections.index') }}">Manage
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link" href="{{ route('admin.admission_item_sections.index') }}">Manage
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="{{ Request::routeIs('admin.settings.*') ? 'active' : '' }}">
                <a href="{{ route('admin.settings.index') }}" class="nav-link"><i class="fas fa-cog"></i><span>Site
                        Settings</span></a>
            </li>
        </ul>

...
export default function ScholarInDestination({
    scholarship,
    scholarship_items,
}) {
        ...
        <div className="min-h-screen bg-[#f8fafc] font-mont">
                ...
                <div className="relative container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="text-white z-10">
                        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-[#c3a25d]/30 mb-8">
                            ...
                            <span className="text-[#c3a25d] font-bold text-xs uppercase tracking-widest">
                                Premium Destination 2026
                            </span>
                        </div>
                            ...
                            {scholarship_items?.map((item) => (
                                ...
                                >
                                    <div className="flex items-center gap-6 mb-10">
                                        <h2 className="text-4xl font-bold text-[#1e2d5c]">
                                            {item.title}
                                        </h2>
                                                            ...
                                                            {section.images.map(
                                                                (img, idx) => (
                                                                    <div
                                                                        ...
                                                                        className="relative overflow-hidden rounded-[2rem] shadow-lg border border-slate-100"
                                                                    >
                                                                        <img
                                                                            src={`/${img}`}
            ...
            <footer className="bg-white border-t border-slate-200 py-20 text-center">
                <div className="max-w-4xl mx-auto px-6">
                    <h2 className="text-4xl font-bold text-[#1e2d5c] mb-6">

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Study Destination: {{ $destination->title }}</h4>
                            ...
                            <form action="{{ route('admin.destinations.update', $destination->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="mb-2">
                                            <img src="{{ asset($destination->image) }}" alt="Current Image" width="150"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="mb-2">
                                            <img src="{{ asset($destination->cover_photo) }}" alt="Current Cover"

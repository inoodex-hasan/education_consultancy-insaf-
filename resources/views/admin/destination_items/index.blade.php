...
@section('title', 'All Destination Items')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"> Destination Items</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>All List of Destination Items</h4>
                            <div class="card-header-action">
                                <a href="{{ route('admin.destination_items.create') }}" class="btn btn-primary">

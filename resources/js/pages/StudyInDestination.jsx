...
export default function StudyInDestination({
    ...
    return (
        <>
            <section className="relative pt-36 py-24 overflow-x-hidden  bg-linear-to-br from-blue via-blue/95 to-[#1e2d5c]">
                <Modal
                    isOpen={isModalOpen}
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="text-white space-y-8">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 pt-6">
                                <a
                                    href="https://wa.me/8801880942457?text=Hi!"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group inline-flex items-center justify-center gap-4 px-4 py-5 bg-[#c3a25d] hover:bg-[#d4b870] text-white font-bold text-md md:text-lg rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300"
                                >

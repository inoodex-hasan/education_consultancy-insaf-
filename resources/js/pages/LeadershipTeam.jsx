            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="mt-6 text-xl text-gray-700 max-w-3xl mx-auto">
                        At Insaf Education Consultancy, our team is made up of
                        experienced education counselors and dedicated
                        professionals who are passionate about guiding students
                        toward a successful academic future. Each team member
                        brings in-depth knowledge of university admissions,
                        study abroad programs, and career planning.
                    </p>
                </div>

                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 text-white">
                        ...
                        <div className="flex gap-6 group">
                            <div className="flex-shrink-0">
                                <div className="w-12 h-12 bg-[#c3a25d] rounded-lg flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                                    <span className="text-2xl font-bold text-[#283e77]">
                                        1
                                    </span>
                                </div>
                            </div>
                            <div>
                                <p className="text-xl md:text-2xl leading-relaxed font-light">
                                    Earning a multitude of esteemed awards and
                                    honors,{" "}
                                    <strong className="text-[#c3a25d] font-bold">
                                        Insaf Immigration stands tall
                                    </strong>{" "}
                        ...
                        <div className="flex gap-6 group">
                            ...
                            <div>
                                <p className="text-xl md:text-2xl leading-relaxed font-light">
                                    Our team’s{" "}
                                    <strong className="text-[#c3a25d] font-bold">
                                        unmatched expertise and unwavering
                                        dedication
                                    </strong>{" "}
                                    are key to propelling us to unparalleled
                                    success in the consultancy industry.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-10">
                        <div className="flex gap-6 group">
                            ...
                            <div>
                                <p className="text-xl md:text-2xl leading-relaxed font-light">
                                    ...
                                    <strong className="text-[#c3a25d] font-bold">
                                        Insaf Immigration boasts numerous honors
                                        and awards
                                    </strong>{" "}
                                    that set us apart and fuel our drive to gain
                        ...
                        <div className="flex gap-6 group">
                            ...
                            <div>
                                <p className="text-xl md:text-2xl leading-relaxed font-light">
                                    Let’s proudly present a glimpse of the
                                    remarkable accolades we’ve garnered
                                    throughout our journey as a devoted,{" "}
                                    <strong className="text-[#c3a25d] font-bold">

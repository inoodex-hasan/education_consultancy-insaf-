    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Editing:
                    {{ Str::limit($scholarship_item_section->scholarshipItem->title ?? 'Section', 25) }}</div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="edit-form"
                                action="{{ route('admin.scholarship_item_sections.update', $scholarship_item_section) }}"
                                ...
                                <div class="row">
                                        ...
                                        <select name="scholarship_item_id"
                                            ...
                                            @foreach ($scholarshipItems as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('scholarship_item_id', $scholarship_item_section->scholarship_item_id) == $item->id ? 'selected' : '' }}>
                                                    {{ $item->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="description" class="summernote @error('description') is-invalid @enderror" rows="6">{{ old('description', $scholarship_item_section->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="row" id="existing-images-container">
                                            @forelse ($scholarship_item_section->images ?? [] as $path)

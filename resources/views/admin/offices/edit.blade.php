...
@section('title', 'Edit Office: ' . $office->location)
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Office: {{ $office->location }}</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="phone"
                                            ...
                                            value="{{ old('phone', $office->phone) }}" required>
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="is_primary" value="1"
                                                ...
                                                {{ old('is_primary', $office->is_primary) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="address" class="summernote @error('address') is-invalid @enderror" required>{{ old('address', $office->address) }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
